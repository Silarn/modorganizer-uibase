...
bool ExecutableInfo::isValid() const { return m_Binary.exists(); }

QString ExecutableInfo::title() const { return m_Title; }

QFileInfo ExecutableInfo::binary() const { return m_Binary; }
...
bool ExecutableInfo::isCustom() const { return m_Custom; }
