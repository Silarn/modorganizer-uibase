...
public:
    ...
    enum VersionScheme {
        ...
        SCHEME_NUMBERSANDLETTERS, // for schemes that mix numbers and letters (1.0.1a, 1.0.1c, ...). otherwise this is
                                  // the regular scheme
...
public:
     ...
     * @note due to support for different versioning schemes this somewhat lost it's original intention. This is now
     *supposed to return a version string that can be parsed to re-create this VersionInfo without information loss.
     **/
    QString canonicalString() const;

    /**
     * @return a version string for display to the user. This may loose information as it doesn't contain information
