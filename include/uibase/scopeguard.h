...
class ScopeGuardImpl2 : public ScopeGuardImplBase {
  public:
    static ScopeGuardImpl2<F, P1, P2> MakeGuard(F fun, P1 p1, P2 p2) { return ScopeGuardImpl2<F, P1, P2>(fun, p1, p2); }
...
inline ObjScopeGuardImpl2<Obj1, Ret (Obj2::*)(P1a, P2a), P1b, P2b> MakeGuard(Ret (Obj2::*memFun)(P1a, P2a), Obj1& obj,
                                                                             P1b p1, P2b p2) {
...
#define ON_BLOCK_EXIT(arg)                                                                                             \
    ScopeGuard ANONYMOUS_VARIABLE(scopeGuard) = MakeGuard(arg);                                                        \
    UNUSED_VAR(ANONYMOUS_VARIABLE(scopeGuard))
