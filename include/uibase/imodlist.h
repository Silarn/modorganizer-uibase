...
class IModList {
  ...
  public:
     ...
     * @return true on success, false if the priority change was not possible. This is usually because one of the
     * parameters is invalid
     * @note Very important: newPriority is the new priority after the move. Keep in mind that the mod disappears from
     * it's old location and all mods with higher priority than the moved mod decrease in priority by one.
     */
